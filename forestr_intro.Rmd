...
### Do you use the CTFS R package?

### Do you use github?

### Do you use functions in the __tidyverse__, such as __dplyr__, __ggplot2__ and __tidyr__?

### Do you use any style guide (e.g.__[tidyverse style guide](http://style.tidyverse.org/)__; __[Google's style guide](https://google.github.io/styleguide/Rguide.xml)__)?
...
# Sharing data with R packages | __bci__
...
## File issues (see [ template](https://github.com/forestgeo/learn/issues/20))
...
- submit tutorials (checkout __learnr__)
