...
## _The single biggest way to improve both the quality of your code and your productivity isto reuse good code._ | -― from "Code Complete (Developer Best Practices)" (https://goo.gl/83hsHb)
...
- example of David with pdf.allplot (what functions need work?)
