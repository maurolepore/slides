...
![](https://github.com/forestgeo)



## __forestr__, pricacy and following up

```{r}
include_graphics("forestr_privacy.png")
```
...
```{r}
xxxcont <- function() {
  "add image of twitter"
}
```


## __forestr__: repository  issues
...
## __forestr__: website references
...
## __forestr__: website functions help files
...
## __forestr__: functions help files
