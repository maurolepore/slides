...
`(c)` Note that step 5 is not an exact repetition of 1 and 2 because it starts from a point ahead. The creative process is not linear but iterative, and progress feels circular but is a spiral.
...
- Creativity is an iterative and eliptic process
