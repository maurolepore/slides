...
| where | when | what |
| :--- | :--- | :--- |
| 1, 2 | earlier session (e.g. day before) | write (a), analyse, ..., park downhill (b) |
| 3, 4 | multiple brakes (min-hrs) spread along each day | sleep, shower, run, cook, read | 
| 1, 2 | day/night before | (re)write^1, analyse, ..., park downhill (*) |
| 5 | day/night before | write^1, analyse, ..., park downhill (*) |

| 4 | xxx | xxx |
| 5 | xxx | xxx |
| 3 | night before, morning | sleep, shower |


1. (day/night before) Park donwhill(*)
