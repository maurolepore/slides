...
# Workplan Until May 1'18 | Review and Discuss
...
timeline <- tribble(
  ~n,  ~mlst,  ~extra, ~task,                     ~date_start,    ~date_end,    ~progress,  ~note,
   ...
   1,   T,     F,      "Maintain forestr",        "2017-08-05",  "2017-09-15",  "todo",     "module abundance (8 funs)",
  
   1,   T,     F,      "Maintain forestr",        "2017-09-15",  "2017-10-15",  "todo",     "module biomass (3 funs)",
   1,   T,     F,      "Maintain forestr",        "2017-09-15",  "2017-10-15",  "todo",     "module mortality (5 funs)",
  
   1,   T,     F,      "Maintain forestr",        "2017-10-15",  "2017-11-15",  "todo",     "module growth (7 funs)",
  
   1,   T,     F,      "Maintain forestr",        "2017-11-15",  "2017-12-15",  "todo",     "module demochange (3 funs)",
   1,   T,     F,      "Maintain forestr",        "2017-11-15",  "2017-12-15",  "todo",     "module topography (6 funs)",
...
timeline %>% 
  ...
  geom_text(data = milestones, aes(x = task, y = date_end, label = note), angle = 45, size = 2, hjust = -0.15) +
  labs(y = "date") +
  coord_flip()
```
